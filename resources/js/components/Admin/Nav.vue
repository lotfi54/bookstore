      ...
      >
        <v-list dense> 
          ...
          <v-list-item link>
            ...
            <v-list-item-content>
              <v-list-item-title>Auteurs</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
            </router-link>
...
<router-link to='/livres' exact>
          <v-list-item link>
            ...
            <v-list-item-content>
              <v-list-item-title>Livres</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
            </router-link>
